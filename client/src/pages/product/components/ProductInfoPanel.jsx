...
export function ProductInfoPanel({ product, sizes = PRODUCT.sizes }) {
  ...
  function onAddToBag() {
    ...
    addItem({
      ...
      quantity: 1,
      image: img ? { src: img.src, alt: img.alt } : { src: '', alt: '' },
    })
    nav('/cart')
  }
    ...
    <aside className="col-span-12 lg:col-span-4 flex flex-col gap-xl">
      <div className="sticky top-28">
        <div className="border-b border-black pb-lg mb-lg">
          ...
          <p className="text-headline-sm">{product.priceLabel}</p>
        ...
        <div className="mb-xl">
          <div className="flex justify-between items-end mb-md">
            ...
            <button className="text-body-md underline" type="button">
              SIZE GUIDE
            </button>
          </div>
        ...
        <div className="flex flex-col border-t border-black">
          {product.accordions.map((a) => (
            ...
            >
              ...
              {a.text ? (
                <div className="pb-lg text-body-sm text-on-surface-variant">{a.text}</div>
              ) : null}
            </details>
          ))}
        </div>
