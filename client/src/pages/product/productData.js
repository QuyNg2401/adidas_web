...
export const PRODUCT = {
  ...
  accordions: [
    {
      ...
      paragraphs: [
        ...
        'ADIDAS-FOAM+ midsole offering 25% more responsiveness than standard compounds.',
  ...
  feature: {
    ...
    body: 'The ADIDAS Carbon X1 was designed in collaboration with world-class sprinters. Every millimeter of the shoe serves a singular purpose: reducing ground contact time and increasing forward force.',
    stats: [
